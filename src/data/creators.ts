export const DATA_CREATORS = [
  ...
  },
  {
    id: 'Aforina',
    name: 'Sara Montagud',
    description: 'Experta en la realización de encuestas y copiadora de contenido. En sus streams puedes jugar a kukoro o aprender a trabajar en pair programming, eso sí, codificando el invitado',
    categories: ['frontend'],
    social: [
      {
        id: 'twitch',
